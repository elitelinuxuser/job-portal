        ...
        >
          {hasResponded && myResponse ? (
                ...
                <div className="flex items-center gap-3 p-4 bg-green-50 border-2 border-green-200 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-base font-bold text-green-800">
                      {myResponse.proposedPrice || job.budget}
                    </p>
                  </div>
                </div>
            ...
            <>
              ...
              <div className="relative bg-linear-to-br from-amber-600 via-orange-500 to-orange-600 px-6 pt-6 pb-6">
                <button
                  onClick={() => setOpen(false)}
                  className="absolute top-4 right-4 w-8 h-8 bg-white/20 hover:bg-white/30 backdrop-blur-sm rounded-full flex items-center justify-center transition-colors z-20"
                  aria-label="Close"
              ...
              <div className="px-6 pt-6 pb-6 bg-white space-y-4">
                <div className="flex items-start gap-3 p-4 bg-amber-50 border-2 border-amber-200 rounded-xl">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-amber-800">
                      Your profile is currently under review. You&apos;ll be
                      able to apply for jobs once your profile is verified by
                      our team.
                    </p>
                  </div>
                </div>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <p className="text-sm text-blue-800">
                    <strong>Review Status:</strong> This process typically takes
                    12-24 hours. You&apos;ll receive an email notification once
