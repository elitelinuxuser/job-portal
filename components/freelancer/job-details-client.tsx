...
import { Briefcase, IndianRupee, Sparkles, X, Award, CheckCircle2, TrendingUp } from 'lucide-react'
...
export function JobDetailsClient({ job, hasResponded, myResponse }: JobDetailsClientProps) {
