          ...
          <div className="text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-600">
                We&apos;re sorry, but your company profile was not approved.
              </p>
            </div>
            ...
            <div className="bg-gray-50 rounded-xl p-4 space-y-2">
              <p className="text-sm text-gray-700 leading-relaxed">
                Unfortunately, we were unable to verify your company information. This could be due to:
              </p>
              <ul className="text-sm text-gray-600 text-left space-y-1 ml-4">
                <li>• Incomplete or inaccurate information</li>
                <li>• Unable to verify proof of ownership</li>
                <li>• Company details don&apos;t meet our criteria</li>
              </ul>
            </div>
