...
import { FreelancerBookingsList } from '@/components/freelancer/bookings-list'
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-blue-100">Track and manage all your booking requests</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-8">
        <FreelancerBookingsList bookings={bookings} />
      </div>
    </div>
  )
}
